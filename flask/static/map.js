/* global fetch location uID */

setInterval(runMap, 1000)

async function runMap () {
  const res = await fetch(location.protocol + '//localhost:5000/api/get_minimap', {
    method: 'GET',
    headers: {
...
function renderMinimap (mapArray) {
